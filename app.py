...
st.title("🖨️ पॅनेल मतदार स्लिप जनरेटर (A5 Portrait - Perfect Font Layout)")
...
# जोडाक्षरे आणि वेलांटी परफेक्ट दाखवण्यासाठी Google Noto Serif Devanagari फॉन्ट वापरणे
@st.cache_resource
def register_marathi_font():
    try:
        # Noto Serif Devanagari फॉन्ट जोडाक्षरे एकदम परफेक्ट रेंडर करतो
...
if uploaded_file is not None:
    ...
    def generate_a5_portrait_slips_canvas(data_frame, banner_bytes, polling_station):
        ...
        for index, row in data_frame.iterrows():
            ...
            # १. पॅनेल बॅनर ड्रॉ करणे (वरच्या भागात फिक्स ३८०x९५)
            if banner_bytes:
                try:
            ...
            # कापावे रेष (बॅनरच्या बरोबर खाली)
            ...
            # २. मजकूर पूर्ण पानावरील 'येथून कापावे' च्या खाली सुटसुटीत ठळक टाईप करणे (Font Size 18)
            c.setFillColorRGB(0, 0, 0)
            c.setFont(font_name, 18)
            
            # रेषेच्या बरोबर खाली अंतर ठेवून माहिती सुरू करणे (तुमच्या सेकंड इमेजप्रमाणे)
            start_y = height - 165
            line_gap = 38
    ...
    if st.button("🚀 नवीन A5 Portrait मतदार स्लिप्स पीडीएफ जनरेट करा"):
        ...
        with st.spinner("तुमच्या फुल पेज उभ्या स्लिप्स तयार होत आहेत..."):
            ...
            st.success("🎉 सर्व स्लिप्स A5 Portrait फॉरमॅटमध्ये शुद्ध मराठीत तयार झाल्या आहेत!")
            st.download_button(
