...
if uploaded_pdf is not None:
    try:
        ...
        if st.button("🚀 या पानावरील सर्व ३० स्लिप्स क्रॉप करा"):
            ...
            st.write("---")
            st.subheader(f"🎯 पान क्र. {page_num} मधील सर्व मतदार स्लिप्स (ब्रँडिंगसह):")
            
            # ३ कॉलम्स आणि १० रोज रचना
            col_width = width / 3
    ...
    st.info("👋 **बालजी सायबर पॉईंट:** सुरू करण्यासाठी डाव्या बाजूला डिपार्टमेंटची मूळ पीडीएफ फाईल अपलोड करा. एक्सेल फाईलची गरज नाही!")
